...
export default function IntegrationsPage() {
  ...
  const totalAudiencesSynced = integrations.reduce((sum, i) => sum + i.audiencesSynced, 0)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        ...
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            <CardTitle className="text-sm font-medium">Audiences Synced</CardTitle>
            <CheckCircle className="h-4 w-4 text-green-500" />
          </CardHeader>
          <CardContent>
            <div className="text-2xl font-bold">{totalAudiencesSynced}</div>
            <p className="text-xs text-muted-foreground">
                ...
                {integration.status === 'connected' && (
                  <>
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <span className="font-medium">{integration.audiencesSynced}</span>
                    </div>
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-muted-foreground">Last Sync:</span>
                      <span className="font-medium">
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4 text-sm">
            <div>
              <h4 className="font-medium mb-2">1. Click "Connect" on any platform</h4>
              <p className="text-muted-foreground">
            ...
            <div>
              ...
              <p className="text-muted-foreground">
                Authorize access to create and manage audiences. We only request the minimum required permissions.
              </p>
            </div>
            <div>
              <h4 className="font-medium mb-2">3. Select account</h4>
              <p className="text-muted-foreground">
                Choose which ad account or property to sync with (you can connect multiple accounts)
              </p>
            </div>
            <div>
              <h4 className="font-medium mb-2">4. Configure sync settings</h4>
              <p className="text-muted-foreground">
                Set sync frequency, audience matching settings, and other platform-specific options
              </p>
            </div>
          </div>
        </CardContent>
